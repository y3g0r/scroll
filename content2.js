(function() {
    if (window.readerRunnin) {
        return
    }
    window.readerRunning = true
    ...
    function registerEventListeners() {
        // for (let handlerInfo of eventHandlers) {
        //     handlerInfo.target.addEventListener(handlerInfo.event, handlerInfo.handler)
        // }
